// Verifique se a variável "supabase" está definida antes de continuar
if (typeof supabase === "undefined") {
    console.error("A biblioteca Supabase não foi encontrada. Certifique-se de que foi importada corretamente.");
} else {
